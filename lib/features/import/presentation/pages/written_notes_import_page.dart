...
class WrittenNotesImportPage extends StatefulWidget {
  const WrittenNotesImportPage({super.key});

  @override
  State<WrittenNotesImportPage> createState() => _WrittenNotesImportPageState();
}

class _WrittenNotesImportPageState extends State<WrittenNotesImportPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: KnotAppBar(
        context: context,
        titleText: 'Import from Written Notes',
      ),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Take a photo or select an image of your handwritten notes',
